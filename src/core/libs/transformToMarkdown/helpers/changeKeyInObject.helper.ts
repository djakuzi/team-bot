...
export function changeKeyInObjectFromArray<
  A extends Record<string, unknown>,
  TK extends string,
>(array: A[], changeKey: TypeChangeKey<A, TK>, include: TK[]) {
...
export function changeKeyInObject<
  O extends Record<string, unknown>,
  TK extends string,
>(object: O, include: TK[], changeKey: TypeChangeKey<O, TK>) {
