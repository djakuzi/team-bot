...
import { getUpdate } from '@tb-common/utils/bot/getUpdate.util';
import { COMMANDS_BOT_MENU } from './menu/constant/commands.const';
import { Update as TgUpdate } from 'telegraf/typings/core/types/typegram';
import { ActionsBotSettings } from './settings/updates/action.updates';

@Update()
export class UdpateBot {
	constructor(
		private readonly actionsBotSettings: ActionsBotSettings,
	) { }
	@Command(COMMANDS_BOT.start.command)
