...
export const SCHEME_REMINDER = {
  updates: [CommandsBotReminder, ActionsBotReminder],
  listener: [ListenerBotReminder],
  handlers: [HandlerReminderExecuted],
  scene: [SceneAddReminder],
  service: [
    // ServiceBotCalendar
  ],
};
