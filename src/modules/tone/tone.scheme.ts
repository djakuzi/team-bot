...
export const SCHEME_TONE: ISceneProvider = {
  services: [ServiceTone, ServiceToneSettings],
  factory: [FactoryAddTone, FactoryGetTone, FactorySetTone],
  strategies: [
  ...
  cron: [CronToneUpdateByTime],
  handler: [HandlerToneTimeChanged],
  listener: [ListenerTone],
};
