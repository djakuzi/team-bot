...
export class FactoryCreateSettings {
  ...
  constructor(private readonly сreateBaseSettings: StrategyCreateBaseSettings) {
    this.strategies = {
      сreateBaseSettings: сreateBaseSettings,
    };
  }

  getStrategy<K extends keyof IStrategiesFabricCreate>(
    name: K,
  ): IStrategiesFabricCreate[K] {
